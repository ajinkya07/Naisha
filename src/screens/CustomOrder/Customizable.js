...
class Customizable extends Component {
  constructor(props) {
    ...
    this.rhodiumRef = React.createRef();
  ...
  handlePlainChange = newText =>
    this.setState({
      plain: newText,
    });

  handleRhodiumChange = newText =>
    this.setState({
      rhodium: newText,
    });
  ...
  submitCustomOrder = async () => {
    ...
    if (!grossWeight) {
      ...
      this.showToast('Please enter plain', 'danger');
    }
    else if (!rhodium) {
      this.showToast('Please enter rhodium', 'danger');
    } else if (!quantity) {
              ...
              <View
                ...
                <View style={{ marginHorizontal: 16, marginTop: 20 }}>
                  ...
                  <FloatingLabelTextInput
                    ...
                    onSubmitEditing={() => this.plainRef.current.focus()}
                    returnKeyType='done'
                  />
                  ...
                  <FloatingLabelTextInput
                    ...
                    onChangeText={this.handlePlainChange}
                    resetValue={this.resetFieldSize}
                    width="100%"
                    textInputRef={this.plainRef}
                    onSubmitEditing={() => this.rhodiumRef.current.focus()}
                  />
                  <FloatingLabelTextInput
                    label="Rhodium"
                    value={this.state.rhodium}
                    onChangeText={this.handleRhodiumChange}
                    resetValue={this.resetFieldSize}
                    width="100%"
                    textInputRef={this.rhodiumRef}
